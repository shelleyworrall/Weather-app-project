...
forecastHTML =
  ...
  `
   <div class="col-2">
            ...
            <img src="http://openweathermap.org/im/wn/${forecastDay.weather[0].icon}@2x.png"
            alt=""
            width="42"
            />
...
function getForecast(coordinates) {
  ...
  lat=${coordinates.lat}&lon=${coordinates.lon}&apid=${apiKey}&units=metric`;
